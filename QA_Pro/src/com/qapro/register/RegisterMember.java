...
// aggiungere query per doppie mail
				...
				String useremailCountSql = "select count(email) from user where email = ?" ;
				...
				//System.out.println(lastTime - currentTime+" ms elapsed for inserting");
							   ...
							   if (email != null){
							        ...
							        String subject = "convalida la tua mail!";
							        String content = "<i>Ciao </i><br>";
							        content += "<b>Per convalidare la tua mail clicca il </b><br>";
							        content += "<a href= linkdacliccare > Registration page</a>";
