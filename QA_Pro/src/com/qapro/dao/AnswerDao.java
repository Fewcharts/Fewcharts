...
public class AnswerDao extends JavathlonJdbcTemplate<Answer> {
	...
	String selectAnswerSql = "select id,text,insert_date,is_active,responder_id,question_id, UpVote  from answer ";
	...
	public void voteAnswer(Long answerId, VotingEnum type) throws Exception
	{
		...
		String upVoteSql = "UPDATE answer SET Upvote = +1 where id = :answer_id";
