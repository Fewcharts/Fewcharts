...
public class VoteDaoAnswer extends JavathlonJdbcTemplate<Vote> {
	...
	private String getAllVotes = "SELECT vote.id,vote.question_id,vote.user_id, vote.type,  vote.date, vote.is_cancelled, vote.answer_id FROM qapro.vote";
	private String insertVote = "INSERT INTO qapro.vote(question_id,user_id,type,date,is_cancelled,answer_id)"
