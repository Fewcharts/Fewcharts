...
<jsp:useBean id="question" scope="request" class="com.qapro.entity.GlobalData"></jsp:useBean>
...
<div class="container">
   <!-- Page Heading/Breadcrumbs -->
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">All charts</h1>
        ...
        <!-- /.row -->
                    ...
                    <li>
                        ...
                        <h4><span style="color: #333333"> All charts: </span></h4>
                        <p>	

		
		<br></br>
		<c:forEach var="question" items="${question.questions}">
