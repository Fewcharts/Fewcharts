	    ...
	    if (xmlhttp.readyState == 4){
			...
			if (xmlhttp.status = 200){
				...
				if ('ALREADY_VOTED_UP' == xmlhttp.responseText) {
					...
					if (voteType == 'UP'){
						var total = parseInt(document.getElementById(aid).innerHTML);
...
<span id= "${answer.id}"> ${answer.upVote} </span><button type= "button" onclick = "loadXMLDoc ('UP',${answer.id})">Upvote </button>
