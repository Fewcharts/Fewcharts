	...
	protected void doPost(HttpServletRequest request,
		...
		if (Conditions != null) {
			...
			try {
				...
				emailCountStatement = connection
						.prepareStatement(useremailCountSql);
				...
				if (affectedRowCount > 0) {
					...
					// AGGIUNTO DA ME PER fissare lo userid da utilizzare quando
					// inserisco question
					request.getSession().setAttribute("autoIncrementedUserId",
				...
				String linkdacliccare = (request.getScheme() + "://"
						+ request.getServerName() + ":"
						+ request.getServerPort() + request.getContextPath()
						+ "/validate?key=" + key + "&userid=" + autoIncrementedUserId);
